...
public class Constants {
	//微信
	public final static String URL = "http://s1.music.126.net/download/android/CloudMusic_2.8.1_official_4.apk";
	//QQ
	public final static String URL1 = "http://dl.m.cc.youku.com/android/phone/Youku_Phone_youkuweb.apk";
	public final static String URL2 = "http://dldir1.qq.com/qqmi/TencentVideo_V4.1.0.8897_51.apk";
	public final static String URL3 = "http://wap3.ucweb.com/files/UCBrowser/zh-cn/999/UCBrowser_V10.6.0.620_android_pf145_(Build150721222435).apk";
	public final static String URL4 = "http://msoftdl.360.cn/mobilesafe/shouji360/360safesis/360MobileSafe_6.2.3.1060.apk";
	//
	public final static String IMG = "http://img.wdjimg.com/mms/icon/v1/d/f1/1c8ebc9ca51390cf67d1c3c3d3298f1d_512_512.png";
	public final static String IMG1 = "http://img.wdjimg.com/mms/icon/v1/3/2d/dc14dd1e40b8e561eae91584432262d3_512_512.png";
	public final static String IMG2 = "http://img.wdjimg.com/mms/icon/v1/8/10/1b26d9f0a258255b0431c03a21c0d108_512_512.png";
	public final static String IMG3 = "http://img.wdjimg.com/mms/icon/v1/3/89/9f5f869c0b6a14d5132550176c761893_512_512.png";
	public final static String IMG4 = "http://img.wdjimg.com/mms/icon/v1/d/29/dc596253e9e80f28ddc84fe6e52b929d_512_512.png";

//	public final static String MP3 = "http://dl.sunshinefm.cn/yinpin_web3/2017/02/17/357d6a1ed30ffab25b49fec62d6c1c5f.3gp";

//	public final static String MP31 = "http://dl.sunshinefm.cn/yinpin_web1/2015/10/26/33613ee1a0a64dc21b131763a6830bf5.3gp";
