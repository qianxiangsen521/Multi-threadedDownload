...
public class PermissionUtils {
    ...
    public static final int CODE_READ_SMS = 9;
    public static final int CODE_BATTERY_STATS = 10;
...
//    public static final String PERMISSION_BATTERY_STATS = Manifest.permission.BATTERY_STATS;
